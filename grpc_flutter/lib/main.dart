...
import 'package:grpc_flutter/news_service.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> get_events() async {
    try {
      print("get_events");
      Empty emptyRequest = Empty();
      //helloRequest.name = "Itachi";

      NewsList newsResponse =
          await NewsService.instance.newsClient.getAllNews(emptyRequest);

      print('response');

      ///do something with your response here
      setState(() {
        hello = newsResponse.news.toString();
      });
